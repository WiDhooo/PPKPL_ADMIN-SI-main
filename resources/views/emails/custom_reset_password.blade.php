...
<body style="font-family: Arial, sans-serif; background-color: #f3f4f6; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; padding: 20px; border-radius: 8px; color: #333333;">
    ...
    <h1 style="color: #047857; font-size: 24px; margin-bottom: 10px;">Reset Kata Sandi Anda</h1>
    <p>Halo {{ $user->name }},</p>
    ...
    <p style="text-align: center;">
      <a href="{{ $url }}" style="display: inline-block; margin-top: 20px; padding: 12px 24px; background-color: #047857; color: #ffffff !important; text-decoration: none; border-radius: 6px; font-weight: bold;">Reset Kata Sandi</a>
    </p>
